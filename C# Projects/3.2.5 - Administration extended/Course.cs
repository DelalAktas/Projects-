...
namespace _3._2._4___Administration
{
				class Course
				{
								...
								public Course(string _name)
								{
												...
												groups = new List<ProjectGroup>() { new ProjectGroup(name, groupCounter) };
								} 
								...
								public bool AddStudent(string name, int studentNumber)
								{
												...
												{
																groupCounter = 0;
																groups.Add(new ProjectGroup(name, groupCounter));
												}
                                                
												Student s = new Student(name, groups.Last().name, studentNumber);
												if (s != null)
												{
				...
				class ProjectGroup
				{
								...
								public ProjectGroup(string name, int index)
								{
												this.name = $"PG{index}_{name}";
								}
				}
